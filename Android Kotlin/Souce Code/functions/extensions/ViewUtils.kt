...
fun TextView.addReadMore(maxLength: Int = 120) {
...
fun convertPriceTwoDecimalFormat(view: TextView, price: Float) {
    view.text = "${view.resources.getString(R.string.rupees)} ${String.format("%,.2f", price)}"
}
