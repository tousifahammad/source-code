...
class OnlyOneOpenedAdapter(private val itemList: ArrayList<Item>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            CHILD -> ChildViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_child, parent, false))
            else -> ParentViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_parent, parent, false))
        }
    }
    ...
    inner class ParentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun updateViewState() {
            ...
            if (parentItem.isExpanded) {
                title.text = "click_to_collapse"
            } else {
                title.text = "click_to_expand"
            }
        }
    }
