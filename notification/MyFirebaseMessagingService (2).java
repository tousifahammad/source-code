package com.skillmine.steelhaat.services;
...
import com.skillmine.steelhaat.HomeActivity;
import com.skillmine.steelhaat.R;
import com.skillmine.steelhaat.SP;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void callNotificationTitleMethod(String title, String message_text, Intent intent) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle(title + "callNotificationTitleMethod")
    ...
    public void createNotification(String title, String message, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setSmallIcon(R.drawable.logo)   // required
            ...
            builder.setSmallIcon(R.drawable.logo)   // required
                    //.setColor(getResources().getColor(R.color.colorAccent))
                    .setContentTitle(title + "  createNotification")// required
                    .setContentText(message) // required
                    // .setDefaults(Notification.DEFAULT_ALL)
                    .setAutoCancel(true)
                    .setContentIntent(pendingIntent)
